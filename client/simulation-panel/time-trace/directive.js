...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
define(['app/module', 'd3', 'lodash', 'css!simulation-panel/time-trace/style', 'simulation-panel/stream/service'], function (app, d3, _) {
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	app.directive('amyTimeTrace', ['$window', 'TimerService', 'StreamService', function ($window, TimerService, StreamService) {
		return {
			...
			restrict:    'E',
			templateUrl: 'simulation-panel/time-trace/view.html',
			replace:     false,
			scope:       {
