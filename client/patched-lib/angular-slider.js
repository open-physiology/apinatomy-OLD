                        ...
                        post: function(scope, element, attributes) {
                            ...
                            function updateDOM() {
                                ...
                                function setPointers() {
                                    ...
                                    offset(refs.lowBub,
                                        Math.min(parseInt(offsetFromPercent(percentFromOffset(offsetLeft(refs.minPtr) - halfWidth(refs.lowBub) + pointerHalfWidth))), barWidth - width(refs.lowBub)) + 'px'); // added by mhelvens; TODO: send pull-request


//	                                console.debug(pixelize(barWidth - width(refs.lowBub)));
