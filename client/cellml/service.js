...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	app.factory('CellMLService', ['$http', function ($http) {
		...
		iface.loadModel = function (modelOptions) {
			...
			return $http.post('/resources/cellml/load', modelOptions)
					.then(function (data) { return data.data })
					.then(function (data) { modelState.id = data.id; });
		};
			...
			(function (data) {
				...
				_(BEELER_REUTER_1977.outputVariables).forEach(function (variable, i) {
					_(data[0]).forEach(function (time, ti) {
						result[variable.name] = { // TODO: use proper URI for variables; not just their name
							time : time,
